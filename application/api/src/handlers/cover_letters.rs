...
use std::sync::Arc;
use crate::AppState;
use crate::models::{CoverLetterItem, CoverLetterDetail, TailoredContent};
use crate::ai;
use nanoid::nanoid;
...
pub async fn tailor_cover_letter(
    ...
    let base_cl_id = payload["baseClId"].as_str().ok_or((StatusCode::BAD_REQUEST, "baseClId missing".to_string()))?;
